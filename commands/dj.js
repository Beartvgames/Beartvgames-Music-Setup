...
module.exports = {
  name: "dj",
  description: "Le permite establecer o restablecer el rol de DJ.",
  permissions: "0x0000000000000020",
  options: [{
    name: "set",
    description: "Le permite seleccionar un rol de DJ.",
  ...
  {
    name: "reset",
    description: "Le permite desactivar la función de DJ.",
    type: ApplicationCommandOptionType.Subcommand,
    options: []
  }
  ],
