...
module.exports = {
name: "resume",
description: "Iniciar Una musica que estaba pausada.",
...
try {
    ...
    .setTitle("Resume Music")
    .setColor('RANDOM')
    .setDescription(`**${queue.songs[0].name}**, ${lang.msg72}`)
    
    let error = new EmbedBuilder()
    .setTitle("Error")
    .setColor('RANDOM')
    .setDescription(`${lang.msg71}`)
    return interaction.reply({ embeds: success ? [resume] : [error] }).catch(e => { })
